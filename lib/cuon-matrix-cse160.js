...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        // let maga = other1.magnitude();
        // let magb = other2.magnitude();
        
        // let ang = angleBetween(other1, other2);
        // let y = maga * magb * Math.sin(ang);
        // console.log(maga+" " + magb + " "+ ang + " "+ y);
    ...
    magnitude() {
        // Insert your code here.
        let x2 = this.elements[0] * this.elements[0];
        let y2 = this.elements[1] * this.elements[1];
        let z2 = this.elements[2] * this.elements[2];
        let m = Math.sqrt(x2 + y2+ z2); // Modify this line to calculate this vector's magnitude.
        // Don't delete the return statement.
        return m;
    };
